    ...
    for row in csv_reader:
        if cnt > 0:
            ...
            try:
                ...
                continue
        cnt += 1
plt.legend(["US: Red", "Asia: Green", "Europe: Blue", "Canada: Cyan", "Australasia: Magenta", "South America: Yellow",
            "NAN: Black"], loc='upper right', markerscale=0.01, markerfirst=False)
plt.show()
