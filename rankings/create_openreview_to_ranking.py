...
if __name__ == "__main__":
    openreview = pd.read_csv("../openreview_copy.csv", quotechar = '"')
    ...
    csrankings = dict()
    for year in range(2017, 2022):
        csrankings[year] = parse_csrankings(f"csrankings2_{year}.txt")
    ...
    df.to_csv("ranking_v3.csv", encoding='utf-8', index=False)
